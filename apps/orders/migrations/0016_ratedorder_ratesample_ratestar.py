# Generated by Django 3.1.7 on 2021-07-08 10:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('orders', '0015_cartpositionmodifiergroup_modifier_group'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_samples', models.ManyToManyField(blank=True, to='orders.RateSample', verbose_name='Шаблоны оценки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rates', to='orders.order', verbose_name='Заказ')),
                ('rate_samples', models.ManyToManyField(blank=True, to='orders.RateSample', verbose_name='Шаблоны оценки')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.ratestar', verbose_name='Звезда')),
            ],
            options={
