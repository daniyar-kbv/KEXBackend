...
urlpatterns = [
    path(
        "instagram/",
        InstagramRedirectURLView.as_view(),
        name="instagram_redirect_url_view"
    ),
    path(
        "participate/",
        InstagramAuthParticipationView.as_view(),
        name="instagram_auth_participation_view",
    ),
    path(
        "<uuid:lead_uuid>/",
    ...
    path(
        "<uuid:lead_uuid>/<str:promotion_slug>/",
        PromotionRenderView.as_view(),
        name='promotion_render_view',
    ),
]
